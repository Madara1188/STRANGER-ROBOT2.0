...
─────────────────
      ✪[𝐀𝐧𝐲 𝐓𝐲𝐩𝐞 𝐎𝐟 𝐇𝐞𝐥𝐩](https://t.me/TEAM_DST)✪ 
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="✯𝐎𝐅𝐅𝐈𝐂𝐄✯", url=f"https://t.me/UlTRA_BOT_UPDATES"),
    ],
    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="✯𝐎𝐖𝐍𝐄𝐑✯", url=f"https://t.me/DST_KA_PAPA"
                        ),
                        InlineKeyboardButton(
                            text="✯𝐑𝐄𝐏𝐎✯", 
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [𝗠𝗔𝗗𝗔𝗥𝗔](https://t.me/DST_KA_PAPA)"
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://telegra.ph/file/2b7ec040e2929b335736f.mp4",
                caption=f"""
✨{dispatcher.bot.first_name} ɪs ᴀʟɪᴠᴇ ʙᴀʙʏ.
━━━━━━━━━━━━━
ᴍᴀᴅᴇ ᴡɪᴛʜ ❤️ ʙʏ [𝑆𝐻𝐼𝑉𝐴𝑁𝑆𝐻](https://t.me/DST_KA_PAPA)
